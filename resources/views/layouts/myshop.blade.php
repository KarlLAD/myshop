                                                        ...
                                                        <div class="search-form-select-wrapper">
                                                            <div class="custom-select-1">
                                                                ...
                                                                <select name="category" class="form-control form-select">
                                                                    ...
                                                                    <option value="{{ $itemCategories->name }}">{{ $itemCategories->name }}
                                                                    </option>
                                        ...
                                        <li class="d-none d-sm-inline-flex ms-0">
                                            ...
                                            <div class="header-extra-info-text">
                                                <label class="text-1 font-weight-semibold text-color-default">CALL US
                                                    NOW</label>
                                                <strong class="text-4"><a href="tel:+1234567890" class="text-color-hover-primary text-decoration-none">+123 4567
                                                        890</a></strong>
                                            </div>
                                        </li>
                                    </ul>
                                            ...
                                            <div class="header-nav-feature header-nav-features-cart header-nav-features-cart-big d-inline-flex top-2 ms-2">
                                                <a href="#" class="header-nav-features-toggle" aria-label="">
                                                    ...
                                                    <span class="cart-info">
                                                        <span class="cart-qty"> {{ $itemcart->quantity }} </span>
                                                    </span>
                                                </a>
                                                <div class="header-nav-features-dropdown" id="headerTopCartDropdown">
                                                    <ol class="mini-products-list">
                                                        <li class="item">
                                                            ...
                                                            <a href="{{route('addtocart', $itemProduct->name)}}" title="$itemProduct->name" class="product-image"><img src="{{Storage::url($itemProduct->image)}}" alt="{{ $itemProduct->name }}"></a>
                                                            <div class="product-details">
                                                                <p class="product-name">
                                                                    <a href="#">{{ $itemProduct->name }}</a>
                                                                </p>
                                                                <p class="qty-price">
                                                                    {{ $itemcart->quantity }} X <span class="price">{{ $itemProduct->prix }} €</span>
                                                                </p>
                                                    ...
                                                    <div class="totals">
                                                        ...
                                                        <span class="price-total"><span class="price">{{ ($itemProduct->prix ) * ($itemcart->quantity)}}</span></span>
                                                    </div>
                                                    <div class="actions">
                                                        <a class="btn btn-dark" href="{{ route('cart', '$cart') }}">View Cart</a>
